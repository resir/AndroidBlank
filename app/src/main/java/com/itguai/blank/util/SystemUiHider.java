package com.itguai.blank.util;import android.app.Activity;
...
public abstract class SystemUiHider {
     ...
     * flag will be set on older devices, making the status bar "float" on select
     * of the activity layout. This is most useful when there are no controls at
     * the select of the activity layout.
     * <p>
